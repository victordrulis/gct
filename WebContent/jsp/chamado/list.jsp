...
<title>GCT - Gestão de Chamods Técnicos</title>
<style type="text/css">
.conteudo-topo {
    padding-top: 40px;
}
...
<div class="row conteudo-topo">
        <div class="container">
            ...
            <p>Lista de chamados</p>
                    <a href="../../jsp/chamado/form.jsp">Novo Contato</a>
        </div>
...
<div class="row">
    ...
    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
		<thead>
		  <tr>
	          ...
	          <th class="th-sm">Início</th>
			  <th class="th-sm">Término</th>
  ...
  <tbody>
    <tr>
      ...
      <td>Atribuido</td>
      <td>
            <a href="../../jsp/chamado/show.jsp"><span>Visualizar</span></a>
      </td>
    </tr>
    <tr>
      <td>23</td>
